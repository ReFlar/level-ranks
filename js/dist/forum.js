...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    var pointsText = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.forum.attribute('reflar-level-ranks.pointsText') || flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('reflar-level-ranks.forum.desc.defaultText');
    ...
    return m("div", {
      ...
      title: expTotal + " " + flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('reflar-level-ranks.admin.settings.levelText')
    }, m("span", {
      class: "PostUser-text"
    }, m("span", {
